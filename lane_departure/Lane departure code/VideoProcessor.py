...
def LaneDeparture():
    ...
    stream = cv2.VideoCapture('C:/Users/michael/OneDrive/Visteon/ldwNightDepart.avi') #6 7 8
    ...
    #cropArea = [100,150,800,448] #for ldwNight
    cropArea = [175,250,850,448] #for ldwNightDepart
    sensorsNumber = 50
    sensorsWidth = 70
